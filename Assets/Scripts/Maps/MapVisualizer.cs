...
namespace Maps
{
    public class MapVisualizer : MonoBehaviour
    {
        ...
        private readonly Dictionary<Vector3Int, GameObject> _dictionaryOfObsticals = new();
        ...
        private void VisualizeUsingPrefabs(MapGrid mapGrid, MapData mapData)
        {
            ...
            for (var row = 0; row < mapGrid.Length; row++)
            {
                ...
                if (mapData.ObsticalesArray[index] && cell.IsTaken) cell.ObjectType = MapCellObjectType.Obstical;
                ...
                switch (cell.ObjectType)
                {
                    ...
                    case MapCellObjectType.Obstical:
                        CreatePrefabIndicator(position,
                            tileEnvironmentPrefabs[Random.Range(0, tileEnvironmentPrefabs.Length)], identityQuaternion);
                        break;
